...
<br /><br /><br />
      ...
      />
<div className="pullQuote"><p > “I have not failed. <br /><br />I've just found 10,000 ways that won't work.”<br /><br />- Thomas A. Edison 
</p></div>
...
{/*BREAK*/}
        ...
        <div className="posts-panel posts-panel3 grid">
          {/* Panel's header */}
          <header className="panel-header">
                         <label className="viewHed3">
Borrow Another View
