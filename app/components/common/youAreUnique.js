...
<div className="card-user-profile">
        ...
        <div className="card-user-profile-content card-section">
          ...
          <p className="card-user-profile-name concernHed"> 
            <br />
  "I thought things would be different"<br /><hr />
      </p>
         <br /> <p className="comradeHed6">Sometimes detours are best</p>
    <br />
...
<br /><br /><br />
      ...
      />
<div className="pullQuote"><p > “If you live in such a manner as to stand the test of the last judgment,<br /> you can depend upon it that the world will not speak well of you.” 
  <br /><br />
― Alistair Begg
</p></div>
...
{/*BREAK*/}
        ...
        <div className="posts-panel posts-panel6 grid">
          {/* Panel's header */}
          <header className="panel-header">
                         <label className="viewHed6">
You Are Unique
