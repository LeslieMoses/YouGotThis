...
class iUnderstand extends Component {
  constructor() {
    super();
...
<div className="card-user-profile">
  ...
  "No One Understands"<br /><hr />
         ...
         <br /> <p className="comradeHed4">...so you think</p>
    <br />
...
<br /><br /><br />
      ...
      />
<div className="pullQuote"><p > “People understand me so poorly that they don't even understand my complaint about them not understanding me.” <br /><br />
― Søren Kierkegaard 
</p></div>
...
{/*BREAK*/}
        ...
        <div className="posts-panel posts-panel4 grid">
          {/* Panel's header */}
          <header className="panel-header">
                         <label className="viewHed4">
Someone Understands
            ...
            <section className="pinned-post">
              ...
              <div className="post-item">
                ...
                <a href="#" className="post-thumbnail picHed">
                  ...
                  <img src="/pics/friendsSunDrink.jpg" alt />
                </a>
                {/* Post's text */}
